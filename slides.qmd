...
This page describes some practices I use when generating [RevealJS](https://revealjs.com/) slide decks.
...
lives at [`rick-gilmore.com/cpo-talk-radio-astronomy`](https://rick-gilmore.com/cpo-talk-radio-astronomy).
...
## Center citaition below video

I'm still looking for a solution to centering the citation for a video.

The following works, but I don't especially like it:

``` {.markdown shortcodes="false"}
{{< video https://youtu.be/yWy-wqRtFiI?si=NJb47y9fA41Kga4q >}}
...
This is another thing to try using a div marked with triple colons: `:::`
